...
BatchSize = 64   
LearningRate = 1e-8                    
DatasetPath = r"E:\Research\DataSet\Wild_Life\4th_Season\Image\train\RGB" 
modelPath = r"max_Val_acc_MobileNet_Co-Occurrence_Wild-Life4th_Kfold_part1"          
...
class Trainer():
    ...
    def Train(self,epoch):
        ...
        if v_acc > self.max_acc:
            self.max_acc = v_acc
            with open("models/"+str(modelPath)+"/"+str(modelPath)+".pth", "wb") as f:
...
if __name__ == '__main__':
    ...
    pd.Series(train_label).plot.hist(bins=3)
    plt.show()
