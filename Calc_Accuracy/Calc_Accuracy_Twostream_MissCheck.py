            ...
            for folder_idx,folder in enumerate(zip(Spatial_folderList,Temporal_folderList)):
                ...
                for image_idx,image in enumerate(zip(Spatial_ImageList,Temporal_ImageList)):
                    ...
                    if self.first_counter < self.Tau:
                        ...
                        if pred_idx_twostream != Class_idx:
                            print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
                            #print("Spatial Image:"+str(image[0])+"Temporal Image:"+str(image[1]))
                            print("Spatial Result:"+str(output_spatial)+" Temporal Result:"+str(output_Temporal)+" TwoStream Result:"+str(output_twostream))
...
test = Calc_Accuracy_TwoStream(Spatial_data=r"I:\Wild-Life4th\Normal_MHI_log5\test\RGB",
                                Temporal_data=r"I:\Wild-Life4th\Normal_MHI_log5\test\MHI")

test(Spatial_model=r"I:\TwoStreamCNN_2nd-Season\Models\MobileNet_RGB_Wild-Life4th\MobileNet_RGB_Wild-Life4th.pth",
    Temporal_model=r"I:\TwoStreamCNN_2nd-Season\Models\MobileNet_MHI-tau5_SingleFrame_Wild-Life4th\MobileNet_MHI-tau5_SingleFrame_Wild-Life4th.pth")